...
public class WxMaConfiguration {
    ...
    public WxMaProperties wxMaProperties(){
        WxMaProperties x = new WxMaProperties();
        x.setAppid("wxa34986161c11a27d");
        x.setSecret("7600206f5e9e3491cbdc0a89c73eb50f");
        x.setToken("jianhuanWEIXIN");
        x.setAesKey("NXlQFHenoth25yPvncCiLZgUHd9F82XUi45LYvAGuOr");
        x.setMsgDataFormat("JSON");
        return x;
    }
